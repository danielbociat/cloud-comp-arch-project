...
def update_template(filename, node_label, num_threads, cores = "0"):
...
if __name__ == '__main__':
    ...
    update_template("memcached", config["memcached"][0], 2, "0,1")
    ...
    subprocess.run(["gcloud", "compute", "scp", f"ubuntu@{client_measure}:~/memcache-perf-dynamic/results.txt", "memcached_results.txt", "--zone", "europe-west1-b", 
               "--ssh-key-file", "~/.ssh/cloud-computing"])
